...
```{r gptimebox, out.width = "200px", fig.show = "hold", fig.cap = "An application to the Global Patterns demonstrates how linking in treelapse can be applied to combine hierarchical clustering and parallel coordinates views."}
...
practical analysis workflows, from studying the impact of bacteria on
